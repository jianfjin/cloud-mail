const en = {
    ...
    invalidRecipientMsg: 'Enter valid email addresses for all recipients',
    recipientDuplicateMsg: 'A recipient can only be in To, Cc, or Bcc once',
    ...
    calendarEvents: '{count} calendar events',
    calendarLoading: 'Loading invitation details…',
    calendarTemporarilyUnavailable: 'Invitation details are temporarily unavailable.',
    calendarUnavailable: 'Invitation details are not available for this message.',
    calendarRetry: 'Retry',
    calendarUnsupportedVersion: 'This invitation was created by a newer or unsupported calendar parser.',
    calendarPartialWarning: 'Some invitation details could not be read. The information below may be incomplete.',
    calendarUnsupported: 'This calendar attachment does not contain a supported event.',
    calendarFailed: 'The calendar attachment could not be read safely.',
    calendarNoRenderableEvents: 'No event details are available. The original attachment remains available below.',
    calendarState_parsed: 'Parsed',
    calendarState_partial: 'Partial',
    calendarState_unsupported: 'Unsupported',
    calendarState_failed: 'Failed',
    calendarAction_invitation: 'Invitation',
    calendarAction_update: 'Event update',
    calendarAction_cancellation: 'Event cancellation',
    calendarAction_instanceCancellation: 'Occurrence cancellation',
    calendarAction_calendar: 'Calendar message',
    calendarSenderDeclared: 'sender-declared',
    calendarSenderStatus: 'Sender status: {status}',
    calendarUntitledEvent: 'Untitled event',
    calendarWhen: 'When',
    calendarWhere: 'Where',
    calendarOrganizer: 'Organizer',
    calendarAllDay: 'All day; dates shown as sent',
    calendarFloatingTime: 'Floating time; no time zone was supplied',
    calendarUnresolvedZone: 'Time shown as sent; time zone {zone} could not be resolved',
    calendarViewerZone: 'Shown in {zone}',
    calendarViewerAndSourceZone: 'Shown in {viewerZone}; source time zone {sourceZone}',
    calendarTimeUnavailable: 'Time unavailable',
    calendarJoinMeeting: 'Join on {host}',
    calendarReviewMeetingLink: 'Review link to {host}',
    calendarUnverifiedConfirm: '{host} is not a verified Meet or Teams host. Open this HTTPS link?',
    calendarOpenLink: 'Open link',

const zh = {
    ...
    invalidRecipientMsg: '请输入有效的收件人邮箱地址',
    recipientDuplicateMsg: '同一收件人只能位于收件人、抄送或密送之一',
    ...
    notOwner: '基础邮箱不属于您',
    comingSoon: '即将推出',
    calendarInvitation: '日历邀请',
    calendarEvents: '{count} 个日历活动',
    calendarLoading: '正在加载邀请详情…',
    calendarTemporarilyUnavailable: '邀请详情暂时不可用。',
    calendarUnavailable: '此邮件没有可用的邀请详情。',
    calendarRetry: '重试',
    calendarUnsupportedVersion: '此邀请由更新或不受支持的日历解析器生成。',
    calendarPartialWarning: '部分邀请详情无法读取，下方信息可能不完整。',
    calendarUnsupported: '此日历附件不包含受支持的活动。',
    calendarFailed: '无法安全读取此日历附件。',
    calendarNoRenderableEvents: '没有可显示的活动详情，原始附件仍可在下方下载。',
    calendarState_parsed: '已解析',
    calendarState_partial: '部分解析',
    calendarState_unsupported: '不受支持',
    calendarState_failed: '解析失败',
    calendarAction_invitation: '活动邀请',
    calendarAction_update: '活动更新',
    calendarAction_cancellation: '活动取消',
    calendarAction_instanceCancellation: '单次活动取消',
    calendarAction_calendar: '日历消息',
    calendarSenderDeclared: '由发件人声明',
    calendarSenderStatus: '发件人状态：{status}',
    calendarUntitledEvent: '无标题活动',
    calendarWhen: '时间',
    calendarWhere: '地点',
    calendarOrganizer: '组织者',
    calendarAllDay: '全天；日期按发件人原文显示',
    calendarFloatingTime: '浮动时间；发件人未提供时区',
    calendarUnresolvedZone: '时间按原文显示；无法解析时区 {zone}',
    calendarViewerZone: '以 {zone} 显示',
    calendarViewerAndSourceZone: '以 {viewerZone} 显示；来源时区 {sourceZone}',
    calendarTimeUnavailable: '时间不可用',
    calendarJoinMeeting: '通过 {host} 加入',
    calendarReviewMeetingLink: '检查并打开 {host}',
    calendarUnverifiedConfirm: '{host} 不是已验证的 Meet 或 Teams 主机。是否打开此 HTTPS 链接？',
    calendarOpenLink: '打开链接',
